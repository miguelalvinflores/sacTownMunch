  ...
  up: async (queryInterface, Sequelize) => {
    ...
    const restaurantsArray = [
      ...
      },
      {
        ...
        photo_url: 'https://i.ytimg.com/vi/iszM-bZvYrg/maxresdefault.jpg',
      ...
      },
      {
        ...
        photo_url: 'https://vaya.in/news/wp-content/uploads/2019/03/Italian-food-1280x720.jpg',
      ...
      },
      {
        ...
        photo_url: 'https://www.lajolla.com/wp-content/uploads/2018/09/mexican-food-1280x720.jpg',
        summary: 'Fine Mexican cuisine',
